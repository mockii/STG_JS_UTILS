module.exports = function(grunt) {
    ...
    grunt.registerTask('css', ['clean:css', 'compass:dev', 'copy:css', 'copy:projectToParent']);
    grunt.registerTask('css-release', ['clean:css', 'compass:prod', 'copy:css', 'copy:projectToParent']);

    grunt.registerTask('js', ['jshint','clean:js','templates','concat:dev', 'copy:projectToParent']);
    grunt.registerTask('js-release', ['jshint','clean:js','templates-release','concat:prod','removelogging','ngmin','uglify', 'copy:projectToParent']);

    grunt.registerTask('templates', ['clean:templates', 'html2js', 'concat:dev', 'copy:assets', 'copy:projectToParent']);
    grunt.registerTask('templates-release', ['clean:templates', 'html2js', 'concat:prod', 'copy:assets', 'copy:projectToParent']);
